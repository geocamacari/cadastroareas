...
map.getView().fit([-4265601.170635, -1426742.961969, -4262444.247898, -1424832.408443], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Cadastro de Áreas SEDUR-PMC (informações sensíveis e não compartilháveis)</h2>';
        return titleElement;
    })(),
